...
function HomeView(p) {
  ...
  var tourSteps = {
    1: {
      ...
      body: "Antes de empezar, descarga las Reglas del Juego para saber cómo funciona el sistema de puntos y premios.",
      next: "📌 Ver Reglas \u2192",
      action: function(){ generateTCPDF(settings, lang); }
    },
    2: {
      title: "\ud83d\udccc Reglas del Juego",
      body: "Puedes descargar las Reglas del Juego en cualquier momento usando el enlace debajo de los botones principales.",
      next: "\u2713 Entendido"
    }
  };
    ...
    ${tourStep>0&&html`<div>
      ...
      <div style=${{
        ...
        <div style=${{display:"flex",gap:8}}>
          ...
          <button onClick=${function(){ if(currentStep.action) currentStep.action(); tourNext(); }} style=${{
            flex:2,padding:"9px",borderRadius:9,border:"none",
            background:thm.accentGrad,
            color:thm.onAccent,cursor:"pointer",fontSize:13,fontWeight:700,
