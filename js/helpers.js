...
function genPDF(preds, name, email, titleStr) {
  try {
    ...
    doc.text("Generated by Polla Mundialista 2026  \u00b7  " + new Date().toLocaleString(), M, 290);
...
async function generateTCPDF(settings, lang) {
  ...
  var TX = es ? {
    ...
    s1b2:"Pago a Julian Enrique Mendez Alvarez \u2014 Bancolombia \u00b7 Cuenta de Ahorros 26271974298.",
    ...
    s6pay:"Los premios se pagar\u00e1n mediante transferencia bancaria directa a las cuentas de los ganadores dentro de los 14 d\u00edas posteriores a la Final del torneo.",
    ...
    s8b1:"Esta competici\u00f3n se organiza con fines de entretenimiento entre amigos.",
    ...
    s1b2:"Payment to Julian Enrique Mendez Alvarez \u2014 Bancolombia \u00b7 Savings Acc 26271974298.",
    ...
    s6pay:"Prizes will be paid via direct bank transfer to winners\u2019 accounts within 14 days of the tournament final.",
    ...
    footer:"Polla Mundialista 2026  \u00b7  Generated "+new Date().toLocaleDateString("en-CO"),
  ...
  try {
    ...
    h2(TX.s4);body(TX.s4intro);body(TX.s4a);bullet(TX.s4a1);bullet(TX.s4a2);bullet(TX.s4a3);bullet(TX.s4a4);body(TX.s4b);bullet(TX.s4b1);bullet(TX.s4b2);bullet(TX.s4b3);bullet(TX.s4b4);bullet(TX.s4b5);bullet(TX.s4b6);bullet(TX.s4b7);bullet(TX.s4b8);
...
async function generatePredsPDF(preds, name, email, lang) {
  ...
  try {
    ...
    doc.text("Polla Mundialista 2026  |  "+new Date().toLocaleString(),M,285);
...
async function generateReportPDF(participant, results, settings, lang) {
  ...
  try {
    ...
    doc.text(es?"Polla Mundialista 2026":"World Cup 2026 Sweepstake",W-M,27,{align:"right"});
    y=40;
...
async function generateSummaryPDF(participants, results, settings, lang) {
  ...
  try {
    ...
    doc.text("Polla Mundialista 2026  |  "+scored.length+" participants  |  julimendeza.github.io/polla-col-2026",M,H-5);
